...
<div class="text-center header2 p-1">
    ...
    <p class="m-0">La prise d'anti-inflammatoires (ibuprofène, cortisone ...) pourrait être un facteur d'aggravation de
...
<div class="d-flex justify-content-evenly flex-wrap-reverse flex-lg-nowrap text-center p-2">
    ...
    <div class="partie_1">
        ...
        <button class="ques-btn btn_test w-100"> Démarrer le test </button>

    </div>

    <div class="partie_2">
        <img src="img/SVG/Groupe76.png" width="577" height="394" alt="background">
    </div>
