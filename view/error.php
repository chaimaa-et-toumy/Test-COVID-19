    ...
    <div class=" d-flex flex-column flex-md-row  justify-content-center  gap-5 mt-5">
        <div class="col">
            <ul class="d-flex flex-row m-auto justify-content-center flex-md-column  gap-3 m-0 list-unstyled">
                ...
                <li><a href="#" class=" btn p-0 fw-bold "> Accueil </a></li>
                <li><a href="#" class=" btn p-0 fw-bold blue "> Conseils </a></li>
            </ul>
        </div>
        <div class="col d-flex flex-column gap-3">
            <span class="blue fw-bold h5 m-0">Contacts utiles</span>
            <span class="fw-bold">Chiffre économique "Alo épidémie vigilance"</span>
            <span class="fw-bold green1 h5 m-0">080 100 47 47</span>
            <span class="fw-bold ">Aide médicale urgente</span>
            <span class="fw-bold green1 h5 m-0">114</span>
        </div>
        <div class="col">
